...
* Download the D1M-Solar-Monitor firmware from this repository. Click on the Clone or Download button and select ZIP file. Unzip the file. It contains a folder SolarPowerMonitor-master. That folder contains several folders and files. Copy folders **D1M-Solar-Power-Monitor** and **D1M_calibration** to your Arduino folder.
